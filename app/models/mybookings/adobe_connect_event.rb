module Mybookings
  class AdobeConnectEvent < Event
    ...
    delegate :adobe_connect_participants, :adobe_connect_meeting_room_name, :adobe_connect_meeting_room_uuid, :adobe_connect_meeting_privacy, to: :booking, prefix: true
